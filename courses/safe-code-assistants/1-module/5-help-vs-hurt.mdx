...
### 🟡 Use AI With Extreme Caution For:
...
### ✅ AI Excels At Simple, Repetitive Code:
...
- API migration (old version → new version)
...
### 🟡 Use AI Cautiously For Moderate Complexity:
...
### 🔴 Avoid AI Under Time Pressure When:
...
### ✅ AI Can Help Under Time Pressure For:
...
**Analysis:**
- Security-critical? 🟢 No (assuming todos aren't sensitive)
- Complexity? 🟢 Low (standard CRUD)
- Developer level? 🟢 Works for all levels
- Time pressure? 🟢 AI can speed this up
...
**Analysis:**
- Security-critical? 🔴 Yes (authentication)
- Complexity? 🟡 Moderate
- Developer level? 🔴 Requires expertise
- Time pressure? 🔴 Makes it worse

**Decision: ❌ Don't rely on AI**
...
- Complexity? 🟢 Low
- Developer level? 🟢 Works for all
- Time pressure? 🟢 AI speeds this up
...
**Analysis:**
- Security-critical? 🟡 Potentially (depends on query)
- Complexity? 🔴 High (performance debugging)
- Developer level? 🔴 Needs expertise
- Time pressure? 🔴 Production issue
...
**Analysis:**
- Security-critical? 🟡 Review security changes
- Complexity? 🟢 Mechanical transformation
- Developer level? 🟢 Works with review
- Time pressure? 🟢 AI speeds this up significantly
...
<a id="1">[1]</a> **GitHub (2024)** – [Best Practices for Using GitHub Copilot](https://docs.github.com/en/copilot/using-github-copilot/best-practices-for-using-github-copilot)

<a id="2">[2]</a> **OWASP (2024)** – [AI Security Best Practices for Developers](https://owasp.org/www-project-ai-security-and-privacy-guide/)

<a id="3">[3]</a> **Google (2024)** – [Responsible AI Practices for Developers](https://ai.google/responsibility/responsible-ai-practices/)

<a id="4">[4]</a> **Microsoft (2024)** – [Secure Coding with AI Assistants](https://learn.microsoft.com/en-us/azure/security/develop/secure-coding-with-ai)
