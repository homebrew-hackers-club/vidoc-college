...
- "This suggestion may be from {license} code" warnings
...
- Includes $500,000 IP indemnification
- "Code Referencing" feature flags duplicated code
- Does not train on your private code
- Provides legal protection against IP claims <sup>[16](#16)</sup>

**Amazon CodeWhisperer Professional:**
- Includes IP indemnification for copyright claims
- Reference tracker shows when code matches public repositories
- Code scanning for security and license compliance <sup>[17](#17)</sup>

**Contract checklist:**

```markdown
☐ IP indemnification clause (minimum $500K)
☐ Specifies who owns AI-generated code (should be you)
☐ Provider commits to license compliance
☐ Reference tracking feature enabled
☐ Provider does not train on your code
☐ Data residency and compliance (EU, GDPR)
...
AI providers have a responsibility to help prevent IP contamination. Here's what leading providers are doing (or should do):

### Attribution and Citation

**GitHub Copilot** — "Code Referencing" feature (in beta)
- Flags suggestions that match public code
- Shows the repository, file, and license
- Lets developers decide whether to use it <sup>[15](#15)</sup>
...
- Exclude GPL/AGPL code from training
- Train only on permissively licensed code
- Provide "license-safe" mode

**Amazon CodeWhisperer** already offers this — you can configure it to only suggest code compatible with specified licenses <sup>[17](#17)</sup>.
