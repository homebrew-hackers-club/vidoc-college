...
<Mermaid chart={`
flowchart TD
    A["AI-Generated Code<br/>(Potential Vulnerabilities)"]
    
    A --> B["Layer 1: IDE<br/>Linting • Secrets Detection"]
    B --> C["Layer 2: Pre-commit<br/>Git Hooks"]
    C --> D["Layer 3: CI/CD<br/>SAST • DAST • SCA"]
    D --> E["Layer 4: Code Review<br/>Human Review"]
    E --> F["Layer 5: Production<br/>Runtime Monitoring"]
