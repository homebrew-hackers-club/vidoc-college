...
- **GitHub Copilot for Business** — By default, does not retain prompts or suggestions and does not use your code for training <sup>[6](#6)</sup>
- **GitHub Copilot Individual** — May use your code to improve the model unless you opt out
- **Cursor** — Offers "Privacy Mode" that prevents code from being stored, but this must be explicitly enabled <sup>[7](#7)</sup>
- **ChatGPT Free** — Conversations may be used to train models unless you opt out
- **ChatGPT Enterprise** — Does not use your data for training and offers enhanced data controls <sup>[8](#8)</sup>
...
**Personal/Free Tiers (⚠️ High Risk):**

- **OpenAI ChatGPT Free** — Conversations may be used to train models unless you opt out in settings; 30-day retention by default
- **GitHub Copilot Individual** — Your code snippets may be used to improve the product unless you explicitly disable suggestion matching
- **Claude Free** — Conversations may be used for training; you must opt out manually
- **Google Bard/Gemini Free** — Similar training and retention policies apply

**Enterprise/Business Tiers (✅ Much Safer):**

- **OpenAI ChatGPT Enterprise** — Zero data retention for training; 30-day retention for abuse monitoring only; can be reduced to zero with custom agreements <sup>[8](#8)</sup>
- **GitHub Copilot Business** — No training on your code; no retention of prompts or suggestions; telemetry is limited <sup>[6](#6)</sup>
- **Anthropic Claude for Enterprise** — No training on customer data; configurable retention policies
- **Azure OpenAI Service** — Customer data is not used to train models; data residency options available <sup>[10](#10)</sup>
- **AWS Bedrock** — No training on customer prompts or outputs; data stays within your AWS environment <sup>[11](#11)</sup>
