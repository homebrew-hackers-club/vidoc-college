...
<Woz title="Security Risk Check" description="Test your understanding of AI code risks 🎯" prompt="Ask me 2 questions about the unique security vulnerabilities in AI-generated code and why they differ from human-written code vulnerabilities." />
...
<Woz title="Real-Time Detection Practice" description="Solidify your understanding 🛠️" prompt="Give me a scenario with AI-generated code that has a security vulnerability. Then ask me to identify it and explain how real-time detection would catch it." />
...
<Woz title="Prioritization Exercise" description="Apply what you've learned 📊" prompt="Present me with 3 different vulnerabilities in different services. Ask me to prioritize them based on business context and explain my reasoning." />
...
<Woz title="Integration Planning" description="Plan your implementation 🏗️" prompt="Ask me about my current development workflow and CI/CD setup. Then help me identify the best points to integrate AI code security scanning." />
...
<Woz title="Comprehensive Review" description="Make sure you've got it all! 🎓" prompt="Ask me 3 questions about this guide to test my understanding of securing AI-generated code, including real-time detection, context-aware prioritization, and DevSecOps integration." />